...
import { AppTooltip, CourseContext, useMediaQuery } from "./clientutil";
...
export function SectionLink({children, section, className}: {children: React.ReactNode, section: Section, className?: string}) {
	...
	return <AppTooltip placement={mq ? "top" : "right"} content={
			<div className="flex flex-col p-4 max-w-52 items-start" >
