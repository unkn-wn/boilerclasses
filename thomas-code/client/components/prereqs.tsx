...
export function Prereqs({ prereqs, isChild }: { prereqs: PreReqs, isChild?: boolean }) {
	...
	return <div className={`flex flex-col relative border ${prereqs.type == "and" ? "border-amber-500 bg-amber-800" : "border-sky-300 bg-sky-900"} py-4 pl-3 mt-4 rounded-l-xl ${isChild ? "border-r-0" : "rounded-r-xl"}`} >
