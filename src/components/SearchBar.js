  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full my-4 p-2 pl-10 pr-10 bg-background placeholder:text-tertiary text-primary rounded-md border border-zinc-700 focus:outline-none focus:border-zinc-500"
