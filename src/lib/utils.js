...
export const subjectOptions = [
  ...
  { value: "ARCH", label: "ARCH: Architectural Technology" },
  ...
  { value: "CCE", label: "CCE: Civil & Construction Engr" },
  ...
  { value: "CSCI", label: "CSCI: Computer Science" },
  { value: "CSR", label: "CSR: Consumer Science" },
  { value: "DANC", label: "DANC: Dance" },
  { value: "DCTC", label: "DCTC: Defense Civiln Trng Corps" },
  { value: "DSB", label: "DSB: Daniels School of Business" },
  ...
  { value: "EXPL", label: "EXPL: Exploratory Studies" },
  ...
  { value: "HER", label: "HER: Herron Art: IU" },
  { value: "HETM", label: "HETM: Healthcare Engr Tech Mgmt" },
  { value: "HHS", label: "HHS: College Health & Human Sci" },
  ...
  { value: "IBE", label: "IBE: Integrated Business & Engr" },
  ...
  { value: "IMPH", label: "IMPH: Indstrl & Mlculr Phrmcutc" },
  { value: "IPPH", label: "IPPH: Industrial & Phys Pharm" },
  { value: "INT", label: "INT: Interior Architecture" },
  ...
  { value: "OPP", label: "OPP: Professional Practice" },
  ...
  { value: "QM", label: "QM: Quantitative Methods" },
  { value: "REAL", label: "REAL: Real Estate" },
  { value: "REG", label: "REG: Reg File Maintenance" },
  { value: "REL", label: "REL: Religious Studies" },
  { value: "RPMP", label: "RPMP: Radio Pharm Mfg" },
  ...
  { value: "SCOM", label: "SCOM: Supply Chain & Op Mgmt" },
  ...
  { value: "STRT", label: "STRT: Strategic Management" },
  { value: "SYS", label: "SYS: Purdue Sys Collaboratory" },
  { value: "TCM", label: "TCM: Technical Communications" },
